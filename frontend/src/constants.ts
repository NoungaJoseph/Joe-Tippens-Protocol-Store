...
export const MOCK_PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    brand: "Joe Tippens Protocol",
    price: 750.00,
    prescription: false,
    image: proto1,
    images: [proto1, proto2, proto3, proto4, proto5, proto6],
    description: "This Protocol Helps get rid of all forms and stages of cancer, stop cancer cells growth and prevent cancer reoccurrence.",
    category: 'Protocols',
    rating: 5.0,
    reviews: 12,
