                ...
                <div className="lg:col-span-2">
                    ...
                    <div className="bg-white rounded-xl shadow-lg p-6 mt-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="border border-gray-200 rounded-lg p-4 flex items-center space-x-4 hover:shadow-md transition-shadow cursor-pointer">
                                <div className="w-16 h-16 bg-gray-200 rounded-lg"></div>
                                <div className="flex-1">
                                    <h4 className="font-semibold text-gray-900">First Aid Kit</h4>
                                    <p className="text-sm text-gray-600">Essential supplies</p>
                                    <p className="font-bold text-cyan-600">$34.99</p>
                                </div>
                                <button className="bg-cyan-600 text-white px-3 py-1.5 rounded text-xs font-bold hover:bg-cyan-700">Add</button>
                            </div>
                            <div className="border border-gray-200 rounded-lg p-4 flex items-center space-x-4 hover:shadow-md transition-shadow cursor-pointer">
                                <div className="w-16 h-16 bg-gray-200 rounded-lg"></div>
                                <div className="flex-1">
                                    ...
                                    <p className="font-bold text-cyan-600">$19.99</p>
                                </div>
                                <button className="bg-cyan-600 text-white px-3 py-1.5 rounded text-xs font-bold hover:bg-cyan-700">Add</button>
                            </div>
                        </div>
