  ...
  return (
    <div className="bg-gray-50 min-h-screen pt-24 pb-16">
        ...
        <section className="bg-emerald-900 text-white py-16 mb-12 relative overflow-hidden">
             <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1505751172876-fa1923c5c528?auto=format&fit=crop&q=80&w=2000')] bg-cover bg-center opacity-10"></div>
